              ...
              <div className="bg-white p-8 rounded-[32px] shadow-sm border border-indigo-100">
                ...
                <div className="space-y-6">
                  {enabledSections.map((sectionName) => {
                    ...
                    return (
                      <div key={sectionName} className="border border-indigo-100 rounded-2xl overflow-hidden">
                        {/* Section header */}
                              ...
                              <div className="grid grid-cols-3 gap-3">
                                <div className="space-y-1">
                                  ...
                                  <SmartNumberInput
                                    ...
                                    onChange={(v) => updateScoring(selectedGrade, `${sectionName}::${qType}`, "correct", v)}
                                ...
                                <div className="space-y-1">
                                  ...
                                  <SmartNumberInput
                                    ...
                                    onChange={(v) => updateScoring(selectedGrade, `${sectionName}::${qType}`, "incorrect", v)}
                                ...
                                <div className="space-y-1">
                                  ...
                                  <SmartNumberInput
                                    ...
                                    onChange={(v) => updateScoring(selectedGrade, `${sectionName}::${qType}`, "unattempted", v)}
                              ...
                              {(qType === "multiCorrect" || qType === "matchListOptionFormat") && (
                                <div className="mt-3 pt-3 border-t border-slate-200 space-y-1">
                                  ...
                                  <SmartNumberInput
                                    ...
                                    onChange={(v) => updateScoring(selectedGrade, `${sectionName}::${qType}`, "partialPerCorrect", v)}
                              ...
                              {qType === "matchList" && (
                                <div className="mt-3 pt-3 border-t border-slate-200 space-y-1">
                                  ...
                                  <SmartNumberInput
                                    ...
                                    onChange={(v) => updateScoring(selectedGrade, `${sectionName}::${qType}`, "partialPerMatch", v)}
                                    className="w-full p-2.5 bg-white border border-slate-200 rounded-xl text-center font-black text-amber-600 focus:ring-2 focus:ring-amber-500"
                                  />
                                </div>
                              )}
