...
export default function TestSettingsPage() {
  ...
  const AVAILABLE_BOARDS = ["default", "CBSE", "ICSE", "State Board"];
            ...
            {syllabusGrades.map((displayName) => {
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-2 px-4 py-4 rounded-2xl font-bold transition-all text-sm border ${isSelected
                        ...
                        {paperOptions.map((paperLabel) => {
                          ...
                          return (
                            <button
                              ...
                              className={`flex-1 px-4 py-2 text-sm font-bold rounded-lg transition-all ${effectiveTab === pk
                                        ...
                                        {(syllabusDocsPerSubject[subjectKey] || []).map((doc: any) => {
                                          ...
                                          return (
                                            <button
                                              ...
                                              className={`px-2 py-1 rounded-md text-[10px] font-bold transition-all border ${isLinked
