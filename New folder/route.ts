...
export async function POST(req: Request) {
  ...
  try {
    ...
    const { gradeId, gradeName, steps, finalStep, defaultExamType, examPattern, sections, questionTypes, active } = body;
    ...
    if (typeof gradeName === "string") updateFields.gradeName = gradeName;
